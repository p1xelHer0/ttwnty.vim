...
hi CursorLineNr      ctermfg=8    ctermbg=16   cterm=bold
hi LineNr            ctermfg=20   ctermbg=NONE cterm=NONE
...
hi FloatBorder       ctermfg=16   ctermbg=16   cterm=NONE
...
hi SpellBad          ctermfg=1    ctermbg=NONE cterm=underline
  ...
  hi! li SpellCap    SpellBad
  hi! li SpellLocal  SpellBad
  hi! li SpellRare   SpellBad
...
hi DiagnosticInfo                 ctermfg=8    ctermbg=NONE cterm=NONE 
hi DiagnosticHint                 ctermfg=2    ctermbg=NONE cterm=NONE 
hi DiagnosticUnderlineError       ctermfg=NONE ctermbg=18   cterm=NONE
hi DiagnosticUnderlineWarn        ctermfg=NONE ctermbg=18   cterm=NONE
hi DiagnosticUnderlineInfo        ctermfg=NONE ctermbg=18   cterm=NONE
hi DiagnosticUnderlineHint        ctermfg=NONE ctermbg=18   cterm=NONE

  hi! li LspDiagnosticsDefaultInformation      DiagnosticInfo
  hi! li LspDiagnosticsDefaultError            DiagnosticError
  hi! li LspDiagnosticsDefaultWarning          DiagnosticWarn
  hi! li LspDiagnosticsDefaultHint             DiagnosticHint

" -----------------------------------------------------------------------------
" HTML/Markdown
" -----------------------------------------------------------------------------
hi mkdBlockquote     ctermfg=7    ctermbg=8    cterm=NONE 
hi mkdCode           ctermfg=7    ctermbg=8    cterm=NONE 
hi htmlLink          ctermfg=2    ctermbg=NONE cterm=underline 

  hi! li MarkdownURL String
